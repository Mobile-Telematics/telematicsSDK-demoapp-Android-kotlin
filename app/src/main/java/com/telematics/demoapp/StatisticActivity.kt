...
class StatisticActivity : AppCompatActivity() {
    ...
    protected fun initGraph(infoModel: StatisticInfoModel) {
        ...
        if (graph1 != null && graph1.size != 0) {
            dataSet = getLineDataSet(graph1, ContextCompat.getColor(lineChart.context,
				R.color.graphColor1
			))
        }
        ...
        if (graph2 != null && graph2.size != 0) {
            dataSet2 = getLineDataSet(graph2, ContextCompat.getColor(lineChart.context,
				R.color.graphColor2
			))
        }
        ...
        if (graph3 != null && graph3.size != 0) {
            dataSet3 = getLineDataSet(graph3, ContextCompat.getColor(lineChart.context,
				R.color.graphColor3
			)) // change color!
        }
